        ...
        <React.Fragment>
            <section class="flex row section align-center flex-reverse" id="grid-id">
                ...
                <div className="col large-text-x">
                    <h2 class="">The Learnable Software Developer</h2>
                </div>
            </section>
            ...
            <section className="section-x align-center">
                <div className="col">
                    <img src={require('../../assets/code.png')} alt="code on screen" class="img-fluid" />
                </div>
...
export default SoftwareDeveloperBody;